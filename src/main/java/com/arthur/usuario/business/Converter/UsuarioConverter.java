...
public class UsuarioConverter {
    ...
    public Usuario paraUsuario(UsuarioDTO usuarioDTO) {
        return Usuario.builder()
                ...
                .enderecos(usuarioDTO.getEnderecos() != null ?
                        paraListaEndereco(usuarioDTO.getEnderecos()) : null) //para poder salvar usuario sem email
                .telefones(usuarioDTO.getTelefones() != null ?
                        paraListaTelefone(usuarioDTO.getTelefones()) : null)//para poder salvar usuario sem telefone
                .build();
    }
    ...
    public UsuarioDTO paraUsuarioDTO(Usuario usuarioDTO) {
        return UsuarioDTO.builder()
                ...
                .senha(usuarioDTO.getSenha())
                .enderecos(usuarioDTO.getEnderecos() != null ?
                        paraListaEnderecoDTO(usuarioDTO.getEnderecos()) : null) //para poder salvar usuario sem email
                .telefones(usuarioDTO.getTelefones() != null ?
                        paraListaTelefoneDTO(usuarioDTO.getTelefones()) : null)//para poder salvar usuario sem telefone
                .build();
    }
